...
## Credits / Integration
This mod contains only original mixin code. It references the target mod's classes by name to patch its bush behavior â€” no code from *Berries & Cherries* is included.
